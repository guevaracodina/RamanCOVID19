% A support vector machine (SVM) multi-class classifier is built using a
...
%
% This code was tested on MATLAB R2017b on a Windows 10 operating system
...
%% Expected results (MATLAB R2017b on a Windows 10 operating system)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Confusion Matrix
%    142     5    12
%      2   139    15
...
% Accuracy = 88.82%
% AUC
%         covid: [0.9644 0.9423 0.9787]
%     suspected: [0.9088 0.8703 0.9354]
%       healthy: [0.8697 0.8311 0.8985]
% 
% Optimal ROC points
%     0.9500    0.9119
%     0.9000    0.8077
%     0.8500    0.7800
% 
% Elapsed time is 864.302332 seconds.
% 
% EOF